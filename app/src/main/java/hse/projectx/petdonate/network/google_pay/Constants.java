package hse.projectx.petdonate.network.google_pay;
...
public class Constants {
     ...
     */
    public static final int PAYMENTS_ENVIRONMENT = WalletConstants.ENVIRONMENT_TEST; //TODO PROD
     ...
     */
    public static final String PAYMENT_GATEWAY_TOKENIZATION_NAME = "example";//TODO SET merchant name
    public static final String PAYMENT_GATEWAY_GATEWAY_MERCHANT_ID = "exampleGatewayMerchantId";//TODO SET merchant id
            ...
            new HashMap<String, String>() {
                {
                    ...
                    put("gatewayMerchantId", PAYMENT_GATEWAY_GATEWAY_MERCHANT_ID);
                }
            };
